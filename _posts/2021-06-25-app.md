...
Zur späteren Analyse zeichnet die App die Routen der Tester auf und wird diese später anonymisiert an uns übertragen. Dabei ist uns besonders wichtig, dass aus diesem Datensatz der tatsächliche Wohnort / Arbeitsstädte unserer Tester:Innen nicht hervorgeht. Hierzu wird vor Beginn der Datenübertagung hier dazu ein Artikel erscheinen. Aus diesem Datensatz wollen wir in zukunft unter anderem die tatsächliche Reisezeit und umfahrene Hindernisse entnehmen um das Routing dahingehend anzupassen.
